    ...
    <div className="landing-container">
      ...
      >
        <div className="textarea">
          <h1 ref={(el) => typedTextRefs.current[0] = el} className="constant-gradient-text">Create, Design, Collab</h1>
          <p ref={(el) => typedTextRefs.current[1] = el} className="description-text">
            Group with friends, design, innovate together<br/>
            with our real time collaborative Whiteboard!
          </p>
          <div className="container">
            <button className="btn animated-border" data="Try Whiteboard">
      ...
      >
        ...
        <div className="textarea second-text">
          <h1 ref={(el) => typedTextRefs.current[2] = el} className="constant-gradient-text">Engage Everyone</h1>
          <p ref={(el) => typedTextRefs.current[3] = el} className="description-text">
      ...
      >
        ...
        <div className="textarea">
          <h1 ref={(el) => typedTextRefs.current[4] = el} className="constant-gradient-text">Study Together, Learn Together</h1>
          <p ref={(el) => typedTextRefs.current[5] = el} className="description-text">
